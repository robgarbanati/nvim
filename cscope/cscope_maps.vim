...
if has("cscope")
    ...
    nnoremap <Leader>\c :vert scs find c <C-R>=expand("<cword>")<CR><CR>	
    nnoremap <Leader>\t :vert scs find t <C-R>=expand("<cword>")<CR><CR>	
    nnoremap <Leader>\e :vert scs find e <C-R>=expand("<cword>")<CR><CR>	
    nnoremap <Leader>\f :vert scs find f <C-R>=expand("<cfile>")<CR><CR>	
    nnoremap <Leader>\i :vert scs find i ^<C-R>=expand("<cfile>")<CR>$<CR>	
    nnoremap <Leader>\d :vert scs find d <C-R>=expand("<cword>")<CR><CR>	
